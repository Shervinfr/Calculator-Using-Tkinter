...
class Calculator:
    def __init__(self, master):
        ...
        Button(width=11, height=4, text='x', relief='flat', bg='white', command=lambda: self.show('*')).place(x=270, y=200)
        ...
        Button(width=11, height=4, text='=', relief='flat', bg='lightblue', command=self.solve).place(x=180, y=350)
